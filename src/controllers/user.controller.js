...
const registerUser = asyncHandler (async (req,res) =>  {
    ...
    // validation - nonempty --------------- done
    // check if user already exists (email, username) ------------- done
    // check for images, check for avatar -------------- done
    // upload them to cloudinary, avatar --------------- done
    // create userObject  - create entry in db ----------- done
    // remove password and refreshToken fields from response ------------ done
    ...
    // checking if user already exists (email, username)
